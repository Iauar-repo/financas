...
class Users(db.Model):
    ...
    active = db.relationship(
        "ActiveSessions", backref="user", cascade="all, delete", passive_deletes=True
    )
    blocklist = db.relationship(
        "TokenBlocklist", backref="user", cascade="all, delete", passive_deletes=True
    )
